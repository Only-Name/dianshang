...
public class MwdXml {
    ...
    @XmlPath("/metaInfo/quivSensorName/text()")
    private String quivSensorName;//快视文件对应的xxxx
    ...
    public void setQuivSensorName(String quivSensorName) {
        this.quivSensorName = quivSensorName;
    }
    ...
    public String getQuivSensorName() {
        return quivSensorName;
    }
